...
function Handler:createIconControl()
    ...
    self.control.tooltip = getText("IGUI_CloseTrunk")
    ...
    self.control.prerender = function(btn)
        ...
        -- Icon
        btn:drawTextureScaled(getTexture("media/ui/CleanUI/Icon/Icon_CloseTruckDoor.png"), 0, 0, btn.width, btn.height, 1, 0.7, 0.7, 0.7)
        btn:updateTooltip()
    end
end
