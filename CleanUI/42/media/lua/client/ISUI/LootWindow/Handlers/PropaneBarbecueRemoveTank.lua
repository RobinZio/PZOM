...
function Handler:createIconControl()
    ...
    self.control.tooltip = getText("ContextMenu_Remove_Propane_Tank")
    ...
    self.control.prerender = function(btn)
        ...
        -- Icon
        btn:drawTextureScaled(getTexture("media/ui/CleanUI/Icon/Icon_RemoveTank.png"), 0, 0, btn.width, btn.height, 1, 0.7, 0.7, 0.7)
        btn:updateTooltip()
    end
end
