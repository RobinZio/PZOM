...
if ModOptions and ModOptions.getInstance then
	...
	local optRestoreLocation = settings:getData("restoreLocation")
	optRestoreLocation.name = "UI_P4TidyUpMeister_Options_RestoreLocation_Name"
	optRestoreLocation.tooltip = "UI_P4TidyUpMeister_Options_RestoreLocation_Tooltip"
	...
	local optEnableLightFire = settings:getData("enableLightFire")
	optEnableLightFire.name = "UI_P4TidyUpMeister_Options_EnableLightFire_Name"
	optEnableLightFire.tooltip = "UI_P4TidyUpMeister_Options_EnableLightFire_Tooltip"

	local optEnableRefueling = settings:getData("enableRefueling")
	optEnableRefueling.name = "UI_P4TidyUpMeister_Options_EnableRefueling_Name"
	optEnableRefueling.tooltip = "UI_P4TidyUpMeister_Options_EnableRefueling_Tooltip"
