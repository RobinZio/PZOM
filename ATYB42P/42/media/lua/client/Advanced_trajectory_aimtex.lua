...
function Advanced_trajectory.panel:prerender()
    ...
    self:drawTextureScaled(self.texturetable[1], self.width/2 -texturescal/2 , self.height/2 - multiper- texturescal/2 , texturescal, texturescal, 0.8,AR, AG, AB)
    self:drawTextureScaled(self.texturetable[2], self.width/2 +multiper -texturescal/2 , self.height/2 -texturescal/2 , texturescal, texturescal, 0.8, AR, AG, AB)
    self:drawTextureScaled(self.texturetable[3], self.width/2  -texturescal/2, self.height/2 + multiper-texturescal/2, texturescal, texturescal, 0.8, AR, AG, AB)
    ...
    texturescal = 6
    self:drawTextureScaled(self.texturetable[5], self.width/2 -texturescal/2, self.height/2-texturescal/2 , texturescal, texturescal, 0.8, AR, AG, AB)
...
function Advanced_trajectory.panel:new (x, y, width, height)
    ...
    o.texturetable = {
        ...
        getTexture("media/textures/targetReticle04.png")
    }
   return o
end
